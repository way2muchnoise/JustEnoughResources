...
public class WorldGenWrapper implements IRecipeCategoryExtension, ITooltipCallback<ItemStack> {
    ...
    public void drawInfo(int recipeWidth, int recipeHeight, double mouseX, double mouseY) {
        ...
        Font.small.print(TranslationHelper.translateAndFormat("jer.worldgen.drops"), WorldGenCategory.X_DROP_ITEM, WorldGenCategory.Y_DROP_ITEM - 8);
    ...
    private List<String> getLineTooltip(double mouseX, List<String> tooltip) {
