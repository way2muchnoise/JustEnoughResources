...
public final class Resources
{
    public static final class Gui
    {
        ...
        {
            public static final BackgroundDrawable MOB = new BackgroundDrawable(Textures.Gui.Jei.MOB, 166, 130);
            ...
            public static final BackgroundDrawable ENCHANTMENT = new BackgroundDrawable(Textures.Gui.Jei.ENCHANTMENT, 166, 130);
        }
    }
